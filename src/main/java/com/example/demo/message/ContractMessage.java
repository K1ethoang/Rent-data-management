...
public class ContractMessage {
    ...
    public static final String INVALID_START_DATE = "Start Date is invalid or not be in \"yyyy/mm/dd\" format";
    public static final String INVALID_END_DATE = "End Date is invalid or not be in \"yyyy/mm/dd\" format ";
