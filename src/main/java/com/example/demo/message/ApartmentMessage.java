...
public class ApartmentMessage {
    ...
    public static final String INVALID_RETAIL_PRICE = "Retail Price must be number and greater than or equal to 0";
    public static final String NOT_NULL_NUMBER_OF_ROOM = "Number of room is not null";
    public static final String INVALID_NUMBER_OF_ROOM = "Number of room must be number and greater than or equal to 0";
}